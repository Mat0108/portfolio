export function Randstad(){
    return  <div key="work-0" className="work-0 w-[calc(100vw-188px)] h-[414px] relative mt-4 bg-blue_dark rounded-[30px] p-6">
        <div className="flex justify-between">
            <p className="font-mt-bold text-lg">Développeur full stack dans le service Mobilité</p>
            <p className="font-mt-demi text-lg text-white_blue">nov. 2023 - sept. 2024 </p>
        </div>
        <div className="flex justify-between">
            <p className="font-mt-bold text-md">Randstad</p>
            <p className="font-mt-demi text-md text-white_blue">Paris </p>
        </div>
        <div className="flex flex-col mt-4 w-[70%] text-justify">
            ...
            <p className="mt-4">- <span className="font-mt-bold text-white_blue"> refonte graphique</span> de l’affichage des offres d’emploi pour l'harmoniser avec la nouvelle charte graphique du groupe. </p>
            <p className="mt-2">- <span className="font-mt-bold text-white_blue">développement d’un nouveau composant </span> dans la bibliothèque interne de l’équipe permettant la saisie de différents formats de polices de caractères.  Cette fonctionnalité passe par l'ajout du framework <span className="font-mt-bold text-white_blue">Lexical</span> ainsi que la personalisation de l'editeur de text pour répondre au design prévu. </p>
        </div>
        <div className="absolute right-10 top-0 h-full flex center">
            <img src={"/images/randstad.png"} alt={"randstad"} />
        </div>
        <div className="absolute right-0 bottom-0 flex justify-around p-4 gap-4">
            <img src="/images/tech/r.png" alt="logo_react" className="w-8"/>
            <img src="/images/tech/t.png" alt="logo_typescript" className="w-8"/>
            <img src="/images/tech/ne.png" alt="logo_nestjs" className="w-8"/>
            <img src="/images/tech/md.png" alt="logo_mongodb" className="w-8"/>
            <img src="/images/tech/d.png" alt="logo_docker" className="w-8"/>
...
export function EllisCar(){
    return <div key="work-1" className="work-1 w-[calc(100vw-186px)] h-[414px] relative mt-4 bg-blue_dark rounded-[30px] p-6  ">
        <div className="flex justify-between">
            <p className="font-mt-bold text-lg">Développeur full stack</p>
            <p className="font-mt-demi text-lg text-white_blue">sept. 2022 - sept. 2023 </p>
        </div>
        <div className="flex justify-between">
            <p className="font-mt-bold text-md">Startup EllisCar</p>
            <p className="font-mt-demi text-md text-white_blue">Paris </p>
        </div>
        <div className="flex flex-col mt-4 w-[70%] text-justify">
...
export function Veolia6(){
    return <div key="work-2" className="work-2 w-[calc(100vw-188px)] h-[414px] relative mt-4 bg-blue_dark rounded-[30px] p-6  ">
        <div className="flex justify-between">
            <p className="font-mt-bold text-lg">Stage de 6 mois dans l’équipe Digital Factory</p>
            <p className="font-mt-demi text-lg text-white_blue">mars. 2022 - aout. 2022 </p>
        </div>
        <div className="flex justify-between">
            <p className="font-mt-bold text-md">Veolia</p>
            <p className="font-mt-demi text-md text-white_blue">Paris </p>
        </div>
        <div className="flex flex-col mt-4 w-[75%] text-justify">
        ...
        <div className="absolute right-10 top-0 h-full flex center">
            <img src={"/images/veolia.png"} alt={"veolia"} />
        </div>
        <div className="absolute right-0 bottom-0 flex justify-around p-4 gap-4">
            <img src="/images/tech/a.png" alt="logo_angular" className="w-8"/>
            <img src="/images/tech/j.png" alt="logo_javascript" className="w-8"/>         
        </div>
    </div>
}

export function Veolia4(){
    return <div key="work-3" className="work-3 w-[calc(100vw-188px)] h-[414px] relative mt-4 bg-blue_dark rounded-[30px] p-6  ">
        <div className="flex justify-between">
            <p className="font-mt-bold text-lg">Stage de 4 mois dans l’équipe Digital Factory</p>
            <p className="font-mt-demi text-lg text-white_blue">mars. 2021 - juin. 2021 </p>
        </div>
        <div className="flex justify-between">
            <p className="font-mt-bold text-md">Veolia</p>
            <p className="font-mt-demi text-md text-white_blue">Paris </p>
