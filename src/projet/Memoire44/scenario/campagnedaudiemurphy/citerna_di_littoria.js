...
export const citerna_di_littoria= {
    name:"Cisterna di littoria ",
    terrain:"terrain0",
    medalAllies:6,
    medalAxe:6,
    camp:"Allies",
    ...
    {x:0,y:1,contenu:{case: new Forest(),bunker: null,defense: new SandBag(1), unité:new CharAxis(3,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:0,y:6,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:0,y:7,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:0,y:8,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:0,y:9,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:0,y:10,contenu:{case: new Village(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    {x:0,y:11,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:0,y:12,contenu:{case: new RiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:1,y:4,contenu:{case: new Village(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:1,y:5,contenu:{case: null,bunker: null,defense: new SandBag(1), unité:new ArtillerieAxis(2,[3,3,2,2,1,1],[2]),medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:1,y:11,contenu:{case: new RiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:2,y:1,contenu:{case: null,bunker: new Casemate(),defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    {x:2,y:2,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:2,y:3,contenu:{case: new Village(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    {x:2,y:4,contenu:{case: new Church(),bunker: null,defense: null, unité:null,medal:new Medal(false),action:null,highlight:null,select:null}}, 
    {x:2,y:5,contenu:{case: new Village(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:2,y:8,contenu:{case: null,bunker: new Casemate(),defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:2,y:11,contenu:{case: new RiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:2,y:12,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 

    {x:3,y:0,contenu:{case: new TrainRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:1,contenu:{case: new TrainRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:2,contenu:{case: new TrainRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:3,contenu:{case: new TrainRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:4,contenu:{case: new Station(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:5,contenu:{case: new TrainRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:6,contenu:{case: new TrainRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:7,contenu:{case: new TrainRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:8,contenu:{case: new TrainRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:9,contenu:{case: new TrainRight(),bunker: new Mine(),defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:10,contenu:{case: new RiversRight(2),bunker: new RailBridge(1),defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:11,contenu:{case: new TrainRight(1),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:3,y:12,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 

    {x:4,y:0,contenu:{case: null,bunker: null,defense: new Wire(), unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:4,y:1,contenu:{case: null,bunker: new Mine(),defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:4,y:2,contenu:{case: null,bunker: new Mine(),defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:4,y:3,contenu:{case: null,bunker: null,defense: new Wire(), unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:4,y:4,contenu:{case: new Village(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    {x:4,y:5,contenu:{case: new Village(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    {x:4,y:6,contenu:{case: null,bunker: null,defense: new Wire(), unité:null,medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:4,y:10,contenu:{case: new RiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:5,y:3,contenu:{case: null,bunker: new Mine(),defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:5,y:4,contenu:{case: null,bunker: new Mine(),defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:5,y:5,contenu:{case: null,bunker: new Mine(),defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:5,y:9,contenu:{case: new RiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:6,y:1,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:6,y:8,contenu:{case: null,bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    {x:6,y:9,contenu:{case: new RiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:7,y:6,contenu:{case: new Village(),bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    {x:7,y:7,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:7,y:8,contenu:{case: new RiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:7,y:9,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
    {x:7,y:10,contenu:{case: null,bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
    {x:7,y:11,contenu:{case: new Forest(),bunker: null,defense: null, unité:new ArtillerieAllies(2,[3,3,2,2,1,1],[2]),medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:8,y:1,contenu:{case: null,bunker: null,defense: null, unité:new ArtillerieAllies(2,[3,3,2,2,1,1],[2]),medal:null,action:null,highlight:null,select:null}}, 
    ...
    {x:8,y:9,contenu:{case: null,bunker: null,defense: null, unité:new CharAllies(3,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
    {x:8,y:10,contenu:{case: null,bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
