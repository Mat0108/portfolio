...
import { Bridge, Forest, RiversCurve, RiversRight, SandBag, Village } from "../../haxagone/base";

import { Cemetery, Church } from "../../haxagone/terrain";
export const prise_biesheim= {
name:"La prise de Biesheim",
terrain:"terrain0",
medalAllies:6,
medalAxe:6,
camp:"Allies",
...
hexa:[
   ...
   {x:0,y:2,contenu:{case: new Forest(),bunker: null,defense: null, unité:new CharAxis(4,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:0,y:5,contenu:{case: new RiversRight(3),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:6,contenu:{case: null,bunker: null,defense: new SandBag(1), unité:new ArtillerieAxis(2,[3,3,2,2,1,1],[2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:7,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:8,contenu:{case: new Forest(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:9,contenu:{case: new RiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:1,y:5,contenu:{case: new RiversCurve(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:1,y:6,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:1,y:7,contenu:{case: new RiversRight(),bunker: new Bridge(),defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:1,y:8,contenu:{case: new RiversCurve(3),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:2,y:1,contenu:{case: new Forest(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:2,y:2,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:2,y:3,contenu:{case: new Forest(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:2,y:6,contenu:{case: new Village(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:2,y:7,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:2,y:8,contenu:{case: new Church(),bunker: null,defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:2,y:11,contenu:{case: new Forest(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:3,y:4,contenu:{case: new Cemetery(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:3,y:5,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:3,y:6,contenu:{case: new Village(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:3,y:7,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:3,y:8,contenu:{case: new Village(),bunker: null,defense: new SandBag(1), unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:5,y:4,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:6,y:2,contenu:{case: new Forest(),bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:6,y:3,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:6,y:4,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:6,y:5,contenu:{case: new Forest(),bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:6,y:6,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:6,y:7,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:6,y:8,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:6,y:9,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:6,y:10,contenu:{case: new Forest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:7,y:0,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:1,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:2,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:3,contenu:{case: new RiversRight(),bunker: new Bridge(),defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:4,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:5,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:6,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:7,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:8,contenu:{case: new RiversRight(),bunker: new Bridge(),defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:9,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:10,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:11,contenu:{case: new RiversRight(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:8,y:2,contenu:{case: null,bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:8,y:3,contenu:{case: null,bunker: null,defense: null, unité:new CharAllies(3,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:8,y:5,contenu:{case: null,bunker: null,defense: null, unité:new CharAllies(3,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
   {x:8,y:6,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:8,y:7,contenu:{case: null,bunker: null,defense: null, unité:new ArtillerieAllies(2,[3,3,2,2,1,1],[2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:8,y:8,contenu:{case: null,bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:8,y:9,contenu:{case: null,bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
