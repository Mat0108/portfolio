import { ArtillerieAllies, CharAllies, CharAxis, SoldatAllies, SoldatAxis } from "../../army/army";
import { SandBag } from "../../haxagone/base";
import { Medal } from "../../haxagone/highlight";
import { SnowForest, SnowRiversCurve, SnowRiversRight, SnowVillage } from "../../haxagone/snow";

export const contre_attaque_holtzwihr= {
name:"Contre-Attaque à Holtzwihr",
terrain:"terrain3",
medalAllies:6,
medalAxe:6,
camp:"Axis",
...
hexa:[
   ...
   {x:0,y:1,contenu:{case: null,bunker: null,defense: null, unité:new CharAxis(4,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:2,contenu:{case: null,bunker: null,defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:3,contenu:{case: new SnowVillage(),bunker: null,defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:4,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:5,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:6,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:7,contenu:{case: null,bunker: null,defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:8,contenu:{case: new SnowVillage(),bunker: null,defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:9,contenu:{case: null,bunker: null,defense: null, unité:new CharAxis(4,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:10,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:11,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:0,y:12,contenu:{case: null,bunker: null,defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 

   {x:1,y:0,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:new SoldatAxis(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:2,y:12,contenu:{case: new SnowRiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:3,y:11,contenu:{case: new SnowRiversCurve(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:4,y:1,contenu:{case: new SnowForest(),bunker: null,defense: new SandBag(), unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:4,y:2,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:4,y:6,contenu:{case: new SnowForest(),bunker: null,defense: new SandBag(), unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:4,y:9,contenu:{case: new SnowForest(),bunker: null,defense: new SandBag(), unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:4,y:12,contenu:{case: new SnowRiversCurve(4),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 

   {x:5,y:0,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:5,y:1,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:5,y:2,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:5,y:6,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:5,y:7,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:5,y:8,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:new CharAllies(3,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:5,y:11,contenu:{case: new SnowRiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:6,y:1,contenu:{case: null,bunker: null,defense: null, unité:new CharAllies(3,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
   {x:6,y:2,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:6,y:7,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:new Medal(true),action:null,highlight:null,select:null}}, 
   {x:6,y:8,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:6,y:11,contenu:{case: new SnowRiversRight(2),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:7,y:1,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:2,contenu:{case: new SnowVillage(),bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:new Medal(true),action:null,highlight:null,select:null}}, 
   {x:7,y:3,contenu:{case: null,bunker: null,defense: null, unité:new CharAllies(3,[3,3,3],[1,1,1]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:7,y:6,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:new SoldatAllies(4,[3,2,1],[1,2]),medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:7,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:8,contenu:{case: new SnowForest(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:9,contenu:{case: null,bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   {x:7,y:10,contenu:{case: new SnowRiversCurve(),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:8,y:6,contenu:{case: new SnowForest(),bunker: null,defense: new SandBag(), unité:new ArtillerieAllies(2,[3,3,2,2,1,1],[2]),medal:null,action:null,highlight:null,select:null}}, 
   ...
   {x:8,y:11,contenu:{case: new SnowRiversRight(3),bunker: null,defense: null, unité:null,medal:null,action:null,highlight:null,select:null}}, 
