export const SpaceXPresentation = ()=>{
 return <div className="flex flex-col h-full bg-black_darked p-8 gap-8 overflow-auto text-md">
        <div className="w-full flex gap-8">
            <div className="w-[20%] h-full bg-blue_dark rounded-[30px] p-4 flex flex-col center relative">
        ...
        <div className="w-full h-full flex flex-row gap-8">
                <div className="w-[65%] h-full flex center relative">
                    <img src={"/images/SpaceX/SpaceX_2.png"} alt="spacex" className="rounded-[30px] border-2 border-gray" />
                </div>
                <div className="w-[35%] h-full bg-black_true rounded-[30px] p-4 flex flex-col center relative">
                ...
                <div className="w-full h-full flex flex-row gap-8">
                    ...
                    <div className="w-[60%] h-full flex center relative">
                        <img src={"/images/SpaceX/SpaceX_3.png"} alt="spacex" className="rounded-[30px] border-2 border-gray" />
                    </div>          
                    <div className="w-[20%] text-left h-full bg-dark_green rounded-[30px] p-4 flex flex-col center relative ">
